...
'''
CNAPP provides end-to-end protection for cloud-native environments, addressing both security and operational challenges.
'''

# Read my File
df = pd.read_csv('./data/cnapp-data.csv') 
